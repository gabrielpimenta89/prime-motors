...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/06/2026 às 13:55
...
INSERT INTO `carros` (`id_carro`, `marca`, `modelo`, `ano`, `cor`, `combustivel`, `km`, `n_chassi`, `preco`) VALUES
(2, 'Ferrari', 'Roma', '2026', 'Preta', 'Gasolina', 0, '73273731', 4700000.00);
